...
export interface Subscription {
  id: string; fishery_id: string; user_id: string; plan: string;
...
export interface AdminStats {
  ...
  fisheries_catalog: number; shops: number; pzw_waters: number; pois_total: number;
  reviews_total: number; catches_total: number;
  visits_total: number; visits_today: number; visits_month: number;
  visits_series: { d: string; visits: number }[];
